package dev.redelegends.nms.v1_8_R3;

import com.google.common.base.Preconditions;
import com.mojang.authlib.GameProfile;
import com.mojang.authlib.properties.Property;
import dev.redelegends.nms.interfaces.INMS;
...
import dev.redelegends.libraries.npclib.npc.EntityControllers;
import dev.redelegends.libraries.npclib.npc.ai.NPCHolder;
...
import dev.redelegends.nms.v1_8_R3.entity.EntityArmorStand;
import dev.redelegends.nms.v1_8_R3.entity.EntityItem;
import dev.redelegends.nms.v1_8_R3.entity.EntityNPCPlayer;
import dev.redelegends.nms.v1_8_R3.entity.EntityStand;
import dev.redelegends.nms.v1_8_R3.entity.HumanController;
import dev.redelegends.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import dev.redelegends.nms.v1_8_R3.utils.UUIDMetadataStore;
import dev.redelegends.reflection.Accessors;
import dev.redelegends.nms.v1_8_R3.entity.EntitySlime;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_NAME.get(null).put(EntityStand.class, "LegendsCore-EntityStand");
    CLASS_TO_ID.get(null).put(EntityArmorStand.class, 30);
    CLASS_TO_NAME.get(null).put(EntityArmorStand.class, "LegendsCore-ArmorStand");
    CLASS_TO_ID.get(null).put(EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(EntitySlime.class, "LegendsCore-Slime");
    CLASS_TO_ID.get(null).put(EntityItem.class, 1);
    CLASS_TO_NAME.get(null).put(EntityItem.class, "LegendsCore-Item");
