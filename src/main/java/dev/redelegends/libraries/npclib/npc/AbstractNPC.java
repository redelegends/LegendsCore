...
import dev.redelegends.libraries.npclib.api.event.*;
import dev.redelegends.libraries.npclib.api.metadata.MetadataStore;
import dev.redelegends.libraries.npclib.api.metadata.SimpleMetadataStore;
...
import dev.redelegends.libraries.npclib.trait.CurrentLocation;
...
public class AbstractNPC implements NPC {
  ...
  public boolean despawn() {
    ...
    Bukkit.getOnlinePlayers().forEach(player -> {
      ...
      Team team = sb.getTeam("LegendsNPCS");
      if (team != null) {
          ...
          for (Player players : Bukkit.getServer().getOnlinePlayers()) {
            if (!NPCLibrary.isNPC(players)) {
              ...
              if (data().get(HIDE_BY_TEAMS_KEY, false)) {
                if (team == null) {
                  team = sb.registerNewTeam("LegendsNPCS");
