package dev.redelegends.libraries.holograms;
...
public class HologramLibrary {
  ...
  public static final LegendsLogger LOGGER = ((LegendsLogger) Core.getInstance().getLogger()).getModule("HOLOGRAMS");
  ...
  public static void setupHolograms(LegendsPlugin pl) {
    if (plugin != null) {
      return;
    }
