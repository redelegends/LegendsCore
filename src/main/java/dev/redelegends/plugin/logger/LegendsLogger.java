package dev.redelegends.plugin.logger;
...
public class LegendsLogger extends PluginLogger {
  
  private final Plugin plugin;
  private final String prefix;
  private final CommandSender sender;
  
  public LegendsLogger(Plugin plugin) {
    super(plugin);
    this.plugin = plugin;
  ...
  public LegendsLogger(LegendsLogger parent, String prefix) {
    super(parent.plugin);
  ...
  public LegendsLogger getModule(String module) {
    return new LegendsLogger(this, module + ": ");
  }
