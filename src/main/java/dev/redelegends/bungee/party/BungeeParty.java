package dev.redelegends.bungee.party;
...
import static dev.redelegends.party.PartyRole.LEADER;
...
public class BungeeParty extends Party {
  ...
  private void sendData(String extraKey, String extraValue, Collection<ServerInfo> serverInfos) {
    ...
    serverInfos.forEach(info -> info.sendData("LegendsCore", out.toByteArray()));
  }
