...
import dev.redelegends.cash.CashManager;
...
public class LegendsCoreExpansion extends PlaceholderExpansion {
  ...
  public String onPlaceholderRequest(Player player, String params) {
    ...
    if (params.startsWith("online")) {
      ...
      String table = "LegendsCoreSkyWars";
      ...
      String table = "LegendsCoreTheBridge";
      ...
      String table = "LegendsCoreBuildBattle";
      ...
      String table = "LegendsCoreMurder";
      ...
      String table = "LegendsCoreBedWars";
