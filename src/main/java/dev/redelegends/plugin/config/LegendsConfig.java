package dev.redelegends.plugin.config;
...
public class LegendsConfig {
  ...
  private static final Map<String, LegendsConfig> cache = new HashMap<>();
  private final LegendsPlugin plugin;
  private final File file;
  private YamlConfiguration config;
  
  private LegendsConfig(LegendsPlugin plugin, String path, String name) {
    this.plugin = plugin;
  ...
  public static LegendsConfig getConfig(LegendsPlugin plugin, String path, String name) {
    if (!cache.containsKey(path + "/" + name)) {
      cache.put(path + "/" + name, new LegendsConfig(plugin, path, name));
    }
