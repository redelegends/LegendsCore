...
import dev.redelegends.libraries.npclib.npc.skin.SkinPacketTracker;
import dev.redelegends.libraries.npclib.npc.skin.SkinnableEntity;
import dev.redelegends.nms.NMS;
import dev.redelegends.nms.v1_8_R3.network.EmptyNetHandler;
import dev.redelegends.nms.v1_8_R3.utils.controllers.PlayerControllerJump;
import dev.redelegends.nms.v1_8_R3.utils.controllers.PlayerControllerLook;
import dev.redelegends.nms.v1_8_R3.utils.controllers.PlayerControllerMove;
...
import dev.redelegends.nms.NMS;
import dev.redelegends.nms.v1_8_R3.network.EmptyNetHandler;
import dev.redelegends.nms.v1_8_R3.utils.PlayerNavigation;
import dev.redelegends.nms.v1_8_R3.utils.controllers.PlayerControllerJump;
import dev.redelegends.nms.v1_8_R3.utils.controllers.PlayerControllerLook;
import dev.redelegends.nms.v1_8_R3.utils.controllers.PlayerControllerMove;
import dev.redelegends.utils.Utils;
...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder, SkinnableEntity {
  ...
  private final dev.redelegends.libraries.npclib.api.npc.NPC npc;
  ...
  public EntityNPCPlayer(MinecraftServer server, WorldServer world, GameProfile profile, PlayerInteractManager manager, dev.redelegends.libraries.npclib.api.npc.NPC npc) {
  ...
  @Override
  public dev.redelegends.libraries.npclib.api.npc.NPC getNPC() {
    return npc;
  }
