...
public class MurderAchievement extends Achievement {
  ...
  protected boolean check(Profile profile) {
    return profile.getStats("LegendsCoreMurder", this.stats) >= this.reach;
  }
  
  public ItemStack getIcon(Profile profile) {
    long current = profile.getStats("LegendsCoreMurder", this.stats);
  ...
  static class CoinsReward implements MurderReward {
    ...
    public void give(Profile profile) {
      profile.getDataContainer("LegendsCoreMurder", "coins").addDouble(this.amount);
    }
  }
